...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="css/template-urbanbrain.css">
    ...
    <body>
        <main>
            ...
            <div class="offcanvas offcanvas-end overflow-y-scroll overflow-x-hidden" data-bs-scroll="true" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">                
                <!-- Login utente -->
                <div class="login-box">
                ...
                <div class="signup-box">
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title" id="offcanvasExampleLabel">New member Sign Up</h5>
                    </div>
                    <div class="offcanvas-body d-flex flex-column">
                        <form class="custom-form member-login-form" action="signup_test.php" method="get" role="form">
                            ...
                            <div class="member-login-form-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="email" name="member-signup-email" id="member-signup-email" class="form-control" placeholder="Email" required="">
                                </div>
                                ...
                                <div class="mb-4">
                                    <label class="form-label mb-2" for="member-signup-permission">User permissions</label>

                                    <select name="member-signup-permission" id="member-signup-permission" class="form-control" placeholder="Select a permission" required="">
                                        <option value="" selected disabled hidden>Choose a permission..</option>
                ...
                <div class="mt-auto">
                    <p>
                        ...
                        <!-- <a href="mailto: matteo.bestetti@studenti.unipr.it" class="contact-link">
                            info@urbanbrain.it
                        </a> -->
                        <a href="mailto: alessandro.bertani@studenti.unipr.it" class="contact-link">
                            info@urbanbrain.it
                        </a>
                    </p>
                </div>
                ...
                <!-- Disegno onda in basso -->
                <footer class="site-footer svg-footer-login">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                            <h2 class="text-white">Welcome to the comunity</h2>

                            <h1 class="cd-headline rotate-1 text-white mb-4 pb-2">
                                <span>UrbanBrain is</span>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12 text-center">
                            <h2 class="mb-lg-5 mb-4">About UrbanBrain</h2>
                        </div>
                            ...
                            <div class="section-bg-image-block">
                                ...
                                <form action="#" method="get" class="custom-form mt-lg-4 mt-2" role="form">
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-text bi-envelope-plus" id="basic-addon1"></span>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12 text-center mx-auto mb-lg-5 mb-4">
                            <h2><span>Membership</span> at UrbanBrain</h2>
                        </div>

                        <!-- Tabella permessi utenti -->
                        <div class="col-lg-6 col-12 mb-3 mb-lg-0">
                            <h4 class="mb-4 pb-lg-2">User Permissions</h4>

                            <div class="table-responsive">
                                <table class="table text-center" style="margin-bottom: 0px;">
                                    <thead>
                                        <tr>
                                            <th style="width: 34%; text-align: left;">Type of User</th>
                                            
                                            <th style="width: 22%;">Base</th>
                                            
                                            <th style="width: 22%;">Admin</th>
                                            
                                            <th style="width: 22%;">SuperAdmin</th>
                                        </tr>
                                    </thead>
                        ...
                        <div class="col-lg-5 col-12 mx-auto">
                            ...
                            <div class="custom-form membership-form shadow-lg">
                                <h4 class="text-white mb-4">Why become a member?</h4>
                                <div class="form-floating" style="margin-bottom: 28.333px; color: white;">
                                        Lorem ipsum dolor sit amet, consectetur adipisci elit, sed eiusmod tempor incidunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur. Quis aute iure reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint obcaecat cupiditat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                                </div>
                                <button type="submit" class="form-control" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">Sign Up</button>
                            </div>                            
                        </div>
            ...
            <!-- Paragrafo elenco degli eventi principali -->
                            ...
                            <div class="contact-info mt-5">
                                <div class="contact-info-item">
                                    <div class="contact-info-body">
                                        <strong>Parma, UniPR Campus</strong>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 me-auto mb-5 mb-lg-0">
                        <a class="navbar-brand d-flex align-items-center" href="index.html">
                            <img src="images/logo_scuro.png" class="navbar-brand-image img-fluid" alt="">
                    ...
                    <div class="col-lg-3 col-12">
                        ...
                        <div class="col-lg-2 col-12 ms-auto">
                            ...
                            <p class="copyright-text">Design: <a rel="nofollow" href="https://templatemo.com/tm-587-tiya-golf-club" target="_blank">TemplateMo</a></p>
