                        ...
                        <div class="col-lg-5 col-12 mx-auto">
                            ...
                            <!-- <form action="#" method="post" class="custom-form membership-form shadow-lg" role="form">
                                <h4 class="text-white mb-4">Become a member</h4>
                                    ...
                                    <div class="form-floating" style="margin-bottom: 28.333px">
                                        <input type="text" name="name" id="full-name" class="form-control" style="margin-right: 8px;" placeholder="Name" required="">
                                    ...
                                    <div class="form-floating" style="margin-bottom: 28.333px">
                                        <input type="password" name="password" id="password" style="margin-bottom: 21px;" pattern="(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*_=+-]).{8,16}$" class="form-control" placeholder="Password" required="">
